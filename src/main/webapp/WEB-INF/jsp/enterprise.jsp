...
<div class="index_focus">
    ...
    <div class="header">
    	<div class="content">
        	<div class="top">
            	<div class="share"><a class="ico_share ico_weibo" title="官方微博" href="#" target="_blank"></a>
				                   <a class="ico_share ico_weixin" title="" href="#" target="_blank"><span class="toolbar-layer"></span></a></div>		
            </div>
			...
			<li>
				<a class="pic" href="#" target="_blank">
                	<div class="index_focus_info pic2">
						<h3>“生命就像奔跑的兔子，<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我为自己带盐”</h3>
						<p class="text">姓名：雯雯<br />年龄：22<br />
通过好蛙APP我找到了自己心仪的工作，更幸运的是在这个平台上认识了
        ...
        <div id="cen_right_top">
            ...
            <div class="tab_b">
                ...
                <div class="tab_c style3" style="display:block">
					...
					<P>RPO英文全称：Recruitment Process Outsourcing，是一种以企业客户为导向，以项目为建制的招聘解决方案服务，是着眼于公司在较长的招聘周期内大规模招聘需求提供的定制化解决方案。好蛙 RPO 提供“起点到终点(End to End)”的一站式服务。</P>
                	<p>①固定周期内，有大量的职位需求的企业；<br />②新建项目团队，招聘压力大的企业；<br />③需要二三线城市开展招聘，但所在区域的候选人员能力不均衡，招聘选拔困难的企业；<br />④需要在另外一个城市开设分公司、工厂，但自身人才储备或招聘渠道有限，内部招聘压力大的企业；<br />⑤新组建暂无内部招聘部门的企业。</p>
                    <div class="title2">好蛙服务行业及职位</div>
                    <p>计算机、通信及电子设备制造业<br />机台操作工、维修工、精密组装工、测试工、车工、钳工、铣工、焊工、机电工、磨床工、镭雕工、电镀工、烤漆工、点胶工、热熔<br />工、烧结工、光学测量工、抛光工、品管工、销售、客服、司机等</p>
                    <p>汽车制造业<br />钳工、车工、铣工、磨工、电焊工、钣金工、加工中心操作工、数控铣床操作工、数控车床操作工、数控机床维修工、冲压模具工、<br />液压气动控制工、电火花机操作工、线切割机操作工、注塑模具装配工、汽车维修电工、钻头数控磨床操作工等</p>
                    <p>计算机、通信及电子设备制造业<br />机台操作工、维修工、精密组装工、测试工、车工、钳工、铣工、焊工、机电工、磨床工、镭雕工、电镀工、烤漆工、点胶工、热熔<br />工、烧结工、光学测量工、抛光工、品管工、销售、客服、司机等</p>
					<p>汽车制造业<br />钳工、车工、铣工、磨工、电焊工、钣金工、加工中心操作工、数控铣床操作工、数控车床操作工、数控机床维修工、冲压模具工、<br />液压气动控制工、电火花机操作工、线切割机操作工、注塑模具装配工、汽车维修电工、钻头数控磨床操作工等</p>
                    <div class="title2">好蛙核心产品</div>
                    <p>项目RPO，即为客户某各项目，各层级人员提供完整的招聘流程服务。<br />假期临聘：满足客户因员工假期的短期用工需求<br />定制服务：根据不同的客户需求，菜单式的为客户提供部分招聘流程服务<br />校园招聘：致力于为企业客户制定完善的校园招聘解决方案，提供一站式的校园招聘服务，为企业在校园内建立深远的品牌形象。</p>
                    <div class="title2">好蛙RPO服务流程</div>
                    <p>明确客户用人需求→制定招聘方案→渠道分发→智能匹配→线上邀约→筛选初试→技能测评→入职培训→上岗跟踪</p>
                    <div class="title2">好蛙优势</div>
                    <p>提高招聘效率：好蛙 PRO模式可以帮助您快速、有效地增加或减少招聘操作，以适应不断变化的业务需求。<br />降低招聘成本：专注的招聘流程提供可视化的资源管理和成本控制。<br />提升人才质量：丰富资源和最佳匹配确保您拥有合适的人才以达成目标。<br />智能化数据管理：好蛙 RPO伙伴可以实施领先的技术解决方案来获取数据，为更多灵活、有效的劳动力管理战略提供支持。</p>
                </div>
                <!-- 人才培养 -->
                <div class="tab_c style3" style="display:block">
				
				<div class="title2">什么是BPO</div>
				<p>BPO（Business Process Outsourcing），企业通过管理创新和流程优化，将一些重复性的非核心业务（专项业务、生产工序、业务流程或职能），交给专业的公司或业务承接商来承担的一种商业组织方式。以降低成本，提高服务质量，将企业有限的资源从非核心业务中解放出来，集中到核心业务上，从而提高企业流程自动化的能力。目前我们好蛙外包涉及行业有生产制造，加工业，物流配送，快销、住宿餐饮业等。</p>
...
③我们好蛙的顾问会深入了解企业的岗位职责、用工需求及业务特点，提出最贴切企业需求的解决方案；经验丰富的项目经理，可及时处理项目中可能出现的各种突发状况。
</P>
...
为了帮助派遣员工超过10%的企业，有效规避劳务派遣政策对过度期企业用工风险，好蛙制定了劳务派遣转外包的服务，具体参见（2）人力资源外包服务，包括非核心岗位外包、生产工段外包、独立项目外包、超短期项目外包。
</p>

<div class="title2">劳务派遣转外包的价值</div>
<P>①新政策下，派遣用工的最佳变革方案，规避政策不利影响；
②减轻了企业生产现场管理压力，转移管理风险；
③用人灵活，劳动力需求的短期或季节性波动难题的解决；
④降低薪资总额，福利费科目开支，间接减少企业所得税负担；
⑤降低和控制成本，杜绝了客户用人的隐性成本；
⑥摆脱劳动争议仲裁诉讼案的精力牵制和困扰，有利于维护企业形象；
⑦增强企业核心竞争力
</P>
...
②用工登记、保险缴纳
根据国家规定，我们好蛙为员工缴纳保险及公积金，并为派遣员工办理招工录用和退工手续；

③工资发放、工伤申报
根据客户工资制度和按月提供的工资支付清单，我们好蛙负责承办容员工的工资发放，并代扣代缴员工个人所得税和其他应向国家统筹缴纳的款项。并负责向政府申报派遣员工的工伤认定、理赔事宜。

④政策咨询、争议处理
为客户提供风险防范，我们好蛙提前预防各种劳动争议风险的出现，当出现劳动争议的时候，为客户解决各种问题。劳动法咨询及为企业提供突发事件的处理建议。向企业提供专业的劳动法咨询业务并协作企业处理突发事件。
